...
public class DefAllocatableBlock extends BlockListNode<DefAllocatableBlock> {
	...
	public DefAllocatableBlock(SNetResourceBlockAllocator allocator, SNetResource resource, int cellCapacity) {
		this(allocator, resource, (int) MathUtil.floor2(resource.getCapacity()), cellCapacity);
	}

	private DefAllocatableBlock(SNetResourceBlockAllocator allocator, SNetResource resource, int capacity,
			int cellCapacity) {
