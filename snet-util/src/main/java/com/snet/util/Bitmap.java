...
public class Bitmap {
	...
	public static long getMask(int off) {
		return 1L << (63 - off);
	}

	public static long getMask(int off, int len) {
		len = 64 - len;
		return (L >>> len) << (len - off);
	}

	public static boolean get(final long value, final long mask) {
	...
	public static long and(final long value, final long mask, final boolean b) {
		return b ? (((value & mask) | ~mask) & value) : (value & ~mask);
	}

	public static long or(final long value, final long mask) {
		return value | mask;
	}

	public static long xor(final long value, final long mask) {
		return ((value ^ L) | ~mask) & value;
	}

	public static long not(final long value, final long mask) {
	...
	public boolean equals(final int idx, int len, final boolean b) {
		...
		for (int mapIdx = idx >>> 6, off = idx & 63, remain = 64 - off;
			 len > 0; len -= remain, off = 0, remain = 64, ++mapIdx) {
